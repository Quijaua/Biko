                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="file" id="inputFoto" name="inputFoto"
                                                        class="d-none">
                                                    <label for="inputFoto" class="btn btn- mb-2">Trocar
                                                        foto</label>
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="inputRepresentantesCGU1"
                                                ...
                                                value="{{ $dados->RepresentantesCGU1 }}">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="inputRepresentantesCGU2"
                                                ...
                                                value="{{ $dados->RepresentantesCGU2 }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
