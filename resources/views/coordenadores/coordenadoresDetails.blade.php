                ...
                <div class="col-md-9 p-4">
                    <div class="row mb-3">
                        ...
                        <div class="col-3 d-flex gap-3 justify-content-end align-items-center">
                            ...
                            <div class="col-auto">
                                <a class="btn btn-primary" href="/coordenadores/edit/{{ $dados->id }}"><i
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="inputNomeCoordenador"
                                                    ...
                                                    value="{{ $dados->NomeCoordenador }}" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="inputFuncaoCoordenador"
                                                    ...
                                                    value="{{ $dados->FuncaoCoordenador }}" disabled>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="mb-3">
                                        ...
                                        <div class="col">
                                            <div class="mb-3">
                                                <label class="form-label mb-2" for="aulasForaUneafro">Fora da UNEAFRO,
                                                    você dá aulas?</label>
                                                <select id="aulasForaUneafro" name="aulasForaUneafro" class="form-select" disabled>
                                                    <option selected>Selecione</option>
                                                    <option value="Sim"
                                                        @if ($dados->aulasForaUneafro === 'Sim, em escola regular' || $dados->aulasForaUneafro === 'Sim') {{ 'selected' }} @endif>Sim
                                                    </option>
                                                    <option value="Não"
                                                        @if ($dados->aulasForaUneafro === 'Não') {{ 'selected' }} @endif>Não
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <fieldset>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="isProfessor" id="isProfessor_sim" value="1" @if ($dados->isProfessor === 1) checked @endif>
                                                    <label class="form-check-label" for="isProfessor_sim">Sim</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="isProfessor" id="isProfessor_nao" value="0" @if ($dados->isProfessor === 0) checked @endif>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <br>
                                            <textarea class="form-control" id="inputMotivoPrincipal" name="inputMotivoPrincipal" rows="8" disabled>{{ $dados->MotivoPrincipal }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="inputRepresentantesCGU1"
                                                ...
                                                value="{{ $dados->RepresentantesCGU1 }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="inputRepresentantesCGU2"
                                                ...
                                                value="{{ $dados->RepresentantesCGU2 }}" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <select id="inputEnsinoSuperior" name="inputEnsinoSuperior" class="form-select" disabled>
                                                <option selected>Selecione</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <select id="inputAnoCursoSuperior1" name="inputAnoCursoSuperior1" class="form-select" disabled>
                                                <option selected>Selecione</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <select id="inputAnoCursoSuperior2" name="inputAnoCursoSuperior2" class="form-select" disabled>
                                                <option selected>Selecione</option>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <select id="inputEspecializacao" name="inputEspecializacao" class="form-select" disabled>
                                                <option selected>Selecione</option>
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            <label class="form-label mb-2" for="inputAnoCursoEspecializacao">Ano de
                                                Conclusão</label>
                                            <select id="inputAnoCursoEspecializacao" name="inputAnoCursoEspecializacao" class="form-select" disabled>
                                                <option selected>Selecione</option>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <select id="inputMestrado" name="inputMestrado" class="form-select" disabled>
                                                <option selected>Selecione</option>
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            <label class="form-label mb-2" for="inputAnoCursoMestrado">Ano de
                                                Conclusão</label>
                                            <select id="inputAnoCursoMestrado" name="inputAnoCursoMestrado" class="form-select" disabled>
                                                <option selected>Selecione</option>
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <select id="inputFormacaoAcademicaRecente"
                                                ...
                                                <option value="Sim"
                                                    @if ($dados->FormacaoAcademicaRecente == 'Sim') {{ 'selected' }} @endif>Sim
                                                </option>
                                                <option value="Não"
                                                    @if ($dados->FormacaoAcademicaRecente == 'Não') {{ 'selected' }} @endif>Não
                                                </option>
                                            </select>
                                        </div>
                                    </div>
