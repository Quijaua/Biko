    ...
    <div class="container">
        <div>
            <h1 style="font-size: 35px; line-height: normal;"><span><a href="/psicologos" class="text-primary" aria-label="Voltar para psicólogos">
                    ...
                    </a></span> Detalhes do psicólogo(a)</h1>
        </div>
        <div class="card">
            <div class="row g-0">
                <!-- Form content -->
                <div class="col-md-12 p-4">
                    <div class="row mb-3">
                        ...
                        <div class="col-3 d-flex gap-3 justify-content-end align-items-center">
                            <div>
                                <a class="btn btn-primary" href="/psicologos/edit/{{ $dados->id }}"><i
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('inputCRP') is-invalid @enderror" id="inputCRP"
                                        ...
                                        value="{{ $dados->crp }}" disabled pattern="\d{2}\/\d{5}">
                                    @error('inputCRP')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="telefone" class="form-control @error('inputTelefone') is-invalid @enderror" id="inputTelefone"
                                        ...
                                        value="{{ $dados->telefone }}" disabled pattern="\(\d{2}\)\s\d{5}-\d{4}">
                                    @error('inputTelefone')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control @error('inputEmail') is-invalid @enderror" id="inputEmail"
                                        ...
                                        value="{{ $dados->email }}" placeholder="Endereço de Email" disabled>
                                    @error('inputEmail')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <fieldset>
                                    ...
                                    <div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="supervisora" id="supervisora_sim" value="1" <?php if ($dados->supervisora) {echo 'checked';} ?> disabled>
                                            <label class="form-check-label" for="supervisora_sim">Sim</label>
                                        </div>

                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="supervisora" id="supervisora_nao" value="0" <?php if (!$dados->supervisora) {echo 'checked';} ?> disabled>
