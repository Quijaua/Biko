                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="inputNomeAluno"
                                                ...
                                                placeholder="Nome do novo aluno" value="{{ $dados->NomeAluno }}" 
                                                required>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="mb-3">
                                            <label class="form-label mb-2" for="inputNomeSocial">Nome Social do
                                                aluno</label>
                                            <input value="{{ $dados->NomeSocial }}"  type="text"
                                            ...
                                            <div class="form-check form-check-inline">
                                                @if ($user->role === 'administrador' || $user->role === 'coordenador')
                                                    <input class="form-check-input" name="inputListaEspera"
                                                        ...
                                                        @if ($dados->ListaEspera) checked @else @endif >
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input <?php if (strpos($dados->EnsFundamental, 'particular sem bolsa') !== false) {
                                                    ...
                                                    id="particular_sem_bolsa" value="particular sem bolsa" >
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input max="100" pattern="[0-9]{1,3}" type="number"
                                                ...
                                                value="{{ $dados->PorcentagemBolsaMedio }}" >
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
