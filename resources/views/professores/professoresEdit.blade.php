    ...
    <div class="container">
      <div>
        <h1 style="font-size: 35px; line-height: normal;"><span><a href="/professores" class="text-primary" aria-label="Voltar para professores">
                ...
                </a></span> Detalhes do professor(a)</h1>
    </div>
                            ...
                            <div class="tab-content" id="form-tabs-content">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <fieldset>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="aulasForaUneafro" id="aulasForaUneafroSim" value="sim" @if ($dados->aulasForaUneafro === 'sim') {{ 'checked' }} @endif>
                                                        <label class="form-check-label" for="aulasForaUneafroSim">Sim</label>
                                                    </div>

                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="aulasForaUneafro" id="aulasForaUneafroNao" value="nao" @if ($dados->aulasForaUneafro === 'nao') {{ 'checked' }} @endif>
                                ...
                                <div class="tab-pane fade" id="profissionais" role="tabpanel">
                                    ...
                                    <div class="row">
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="inputProjetosRealizados" id="projetos_realizados_sim" value="sim" onclick="showInput('.projeto-dados')"
                                                            <?php if ($dados->ProjetosRealizados === 'sim') echo 'checked'; ?> aria-controls="projeto-dados" aria-expanded="<?php echo $dados->ProjetosRealizados === 'sim' ? 'true' : 'false'; ?>">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="inputProjetosRealizados" id="projetos_realizados_nao" value="nao" onclick="hideInput('.projeto-dados')"
                                                            <?php if ($dados->ProjetosRealizados === 'nao') echo 'checked'; ?> aria-controls="projeto-dados" aria-expanded="<?php echo $dados->ProjetosRealizados === 'sim' ? 'false' : 'true'; ?>">
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                <label for="comoSoube">Como você ficou sabendo do cursinho
                                        ...
                                        <div class="col-6">
                                            <div class="mb-2">
                                                <fieldset>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="inputEntrevistado" id="entrevistado_sim" value="1" onclick="showInput('.comentarios-entrevista')" @if ($dados->Entrevistado == 1) checked @endif>
                                                        <label class="form-check-label" for="entrevistado_sim">Sim</label>
                                                    </div>

                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="inputEntrevistado" id="entrevistado_nao" value="0" onclick="hideInput('.comentarios-entrevista')" @if ($dados->Entrevistado == 0) checked @endif>
                                    ...
                                    <div class="row comentarios-entrevista" @if ($dados->Entrevistado == 0) style="display:none;" @endif>
                                        <div class="col">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="inputComentariosEntrevista" name="inputComentariosEntrevista" rows="8">{{ $dados->ComentariosEntrevista }}</textarea>
                                            </div>
                                        </div>
                                    </div>
