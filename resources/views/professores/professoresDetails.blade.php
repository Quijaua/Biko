                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <fieldset>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="aulasForaUneafro" id="aulasForaUneafroSim" value="sim" @if ($dados->aulasForaUneafro === 'sim') {{ 'checked' }} @endif disabled>
                                                        <label class="form-check-label" for="aulasForaUneafroSim">Sim</label>
                                                    </div>

                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="aulasForaUneafro" id="aulasForaUneafroNao" value="nao" @if ($dados->aulasForaUneafro === 'nao') {{ 'checked' }} @endif disabled>
