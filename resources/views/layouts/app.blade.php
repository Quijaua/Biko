...
<body>
    ...
    <div>
        ...
        @endguest
        @auth
            <aside class="navbar navbar-vertical navbar-expand-lg navbar-dark bg-dark" style="width: 250px;">
                            ...
                            @if (!\Auth()->user()->first_login)
                                @if (Session::get('role') !== 'aluno')
                                    @if (Session::get('verified'))
                                        ...
                                        <li class="nav-item {{ request()->is('professores') ? 'bg-primary text-white rounded' : '' }}">
                                        ...
                                        <li class="nav-item {{ request()->is('coordenadores') ? 'bg-primary text-white rounded' : '' }}">
                                        ...
                                        <li class="nav-item {{ request()->is('nucleos') ? 'bg-primary text-white rounded' : '' }}">
                                        ...
                                        <li class="nav-item {{ request()->routeIs('nucleo/presences') ? 'bg-primary text-white rounded' : '' }}">
                                ...
                                <li class="nav-item {{ request()->routeIs('nucleo.material') ? 'bg-primary text-white rounded' : '' }}">
                                ...
                                <li class="nav-item  {{ request()->routeIs('messages.index') ? 'bg-primary text-white rounded' : '' }}">
