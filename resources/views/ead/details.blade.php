                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="link" name="link" aria-describedby="linkHelp" value="{{ $ead->link }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="material_apoio" name="material_apoio" aria-describedby="material_apoioHelp" disabled>
                        </div>
                        <div class="mb-3">
